...
Primary_AMLPMP_shared_miRNA <- filter(miRNA_AMLPMP_Primary, miRNA_AMLPMP_Primary$ï..miRNA %in% miRNA_TCGA_Primary$ï..miRNA)
Primary_TCGA_shared_miRNA <- filter(miRNA_TCGA_Primary, miRNA_TCGA_Primary$ï..miRNA %in% miRNA_AMLPMP_Primary$ï..miRNA)
```
