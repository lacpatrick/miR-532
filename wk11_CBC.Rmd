...
transplanter.WBC.control <- ggplot(all.control, aes(x=Transplant.performed.by., y=WBC, fill=Transplant.performed.by.)) +
  ...
  stat_compare_means(comparisons = pair_comparisons, test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
  theme(legend.position="none")
...
comparison.test.control <- ggplot(all.control, aes(x=Transplant.performed.by., y=RBC, fill=Transplant.performed.by.)) +
  ...
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=2, dotsize=3.5) + 
  ylim(0, 15) +
  labs(title = "Test", x = "Treatment", y = "RBC (10"^"6"*"/"~mu~"L)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Transplanter", labels = c("Jeff Lam (n=11)", "Marion van den Bosch (n=5)", "Patrick Lac (n=9)")) +
  stat_compare_means(comparisons=pair_comparisons)
...
comparison.test.miR532 <- ggplot(all.miR532, aes(x=Transplant.performed.by., y=RBC, fill=Transplant.performed.by.)) +
  ...
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Treatment", labels = c("Jeff Lam (n=16)", "Marion van den Bosch (n=5)", "Patrick Lac (n=12)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
  theme(legend.position="none")
